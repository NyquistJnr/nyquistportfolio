        ...
        <section className={`${about.content} ${about.container}`}>
          <div className={about.copy}>
            ...
            <BadgesBlock
              ...
              copy="With over 8 years of experience creating digital assets, I have a deep and intuitive understanding of how the interfaces of the best software products in the world are designed. This is just some of the software I have used over that time."
              list={software}
              block="software"
...
const software = [
  { key: "windows8", name: "Windows", type: "devicons" },
  ...
  { key: "firebase", name: "Firebase CLI", type: "devicon" },
...
const tech = [
  ...
  { key: "djangorest", name: "Django RestFramework", type: "devicon" },
  { key: "keras", name: "Keras", type: "devicon" },
  { key: "tensorflow", name: "Tensorflow", type: "devicon" },
  { key: "openapi", name: "Open API", type: "devicon" },
];
